	...
	return (
		<div>
			<p className="mb-3">
				...
				thinking of making? Type or click below. I’ll take your preferences and
				dietary restrictions into account 😁. When you find a recipe you like,
				you can save it to your recipe book! View your recipe book by clicking
				the button in the top right corner… And you can always add more dietary
